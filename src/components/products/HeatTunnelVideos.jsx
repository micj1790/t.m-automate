...
const videos = [
  { id: 'MfHmbDMoKns', title: 'Shrink Heat Tunnel' },
  { id: 'dBQBrD-E0Eg', title: 'Automatic Shrink Sleeve Labelling Machine' },
];

export default function HeatTunnelVideos() {
    ...
    <section className="mt-0 pt-0">
      <div>
        <div className="mb-8">
          ...
          <h2 className="text-xl font-black text-foreground mt-0.5">Heat Tunnels in Action</h2>
          <p className="text-sm text-muted-foreground mt-1">Watch our heat tunnel and shrink sleeve systems in operation.</p>
        </div>
