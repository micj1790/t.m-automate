...
const fallback = [
  { title: 'Potato Washer System', description: 'Complete automation and control system for high-capacity potato washing equipment. PLC-controlled flow management, water recycling system, and automated cleaning cycles.', client: 'Fresh Produce Corp', industry: 'food_beverage', service_type: 'Potato Washers', location: 'South Africa', year: 2024, status: 'completed', image_urls: ['https://images.unsplash.com/photo-1574314350289-19cfa66b5e5e?w=800&q=80'], results: 'Increased throughput by 40%, reduced water consumption by 35%.' },
  { title: 'Bakery Production Line Control', description: 'Integrated automation system for multi-stage bakery production. Temperature control, humidity monitoring, oven sequencing and packaging coordination with real-time SCADA monitoring.', client: 'National Bakery Group', industry: 'food_beverage', service_type: 'Bakery Equipment', location: 'Pretoria', year: 2024, status: 'completed', image_urls: ['https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=800&q=80'], results: '24/7 automated production with 99.5% uptime and quality consistency.' },
  { title: 'Industrial Control Panels', description: 'Design, manufacture and installation of custom electrical control panels with integrated PLC, VFDs, soft starters and complete HMI integration for factory automation.', client: 'Multiple Industrial Clients', industry: 'manufacturing', service_type: 'Control Panels', location: 'Johannesburg', year: 2024, status: 'completed', image_urls: ['https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=800&q=80'], results: 'Modular design enabling 20% faster deployment across multiple facilities.' },
];
